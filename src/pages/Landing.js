...
import "swiper/css";
import landingBg from '../../public/assets/bg/bg1.jpg'
        ...
        <section className={'w-full px-12 h-[600px] md:h-[700px] lg:h-[100vh] max-h-[100vh] overflow-y-hidden flex flex-col items-center justify-center text-white relative z-1'}>
            ...
            <div className={'h-full w-full flex flex-col items-center justify-center text-white relative z-1'}>
                <div className={'flex flex-col items-center gap-4 md:w-[400px] lg:w-[600px]'}>
                    ...
                    <h1  data-aos="fade-up" data-aos-duration="1000" className={'sm:text-xl md:text-3xl lg:text-6xl font-semibold'} > {t('travelMongolia')}</h1>
                    <Link href={'/trips'} >
                        <Button  data-aos="fade-up" data-aos-duration="1500" >
                            <span className={"font-semibold text-md md:text-xl lg:text-2xl"}>
                                {t('explore')}
                            </span>
            ...
            {/*<div  className={'relative font-semibold max-w-[750px] text-xl mb-[30px] lg:mb-[70px] xl:mb-[100px] w-full px-12 lg:px-24 h-[150px] text-black items-center justify-center z-1 flex flex-col rounded-[12px]'}>*/}
            {/*    {t('create')}*/}
            {/*</div>*/}
        </section>
