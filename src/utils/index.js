...
export const tripsEn = [
  {
    ...
    images: [trip1_2, trip1_3, trip2_2, trip1_4],
  },
  {
    id: "trip2",
  ...
  },
  {
    ...
    paragraph: [
      ...
      "Day 6: The trip will continue towards Khuvsgul province. We will stay overnight in a beautiful wilderness near Shin-Ider sum. You will spend the night in a gher.",
      "Day 7: We will arrive at Khuvsgul lake, the largest freshwater lake in Mongolia by volume and second largest by area. It is also one of the seventeen ancient lakes in the world. On the way, we will be able to see the reindeer stones (historic stone statues with carvings) behind Murun city. We will stay the night close to the beach of Khuvsgul lake at a gher camp. Khuvsgul Eco Tour camp – MNT120,000",
      ...
      "Day 10: Today we will visit the famous Hustain Mountain National Park. The number of horses has reached more than 390 since the area was taken under special protection in 1993 in order to reintroduce wild horses (Przewalski's horses), which were extinct in nature. Deer, marmots, Mongolian antelopes and 213 species of birds inhabit this national park and their numbers are steadily increasing. Take a walk through the park territory and see rare wildlife such as the red-listed zebra. (stay in a tent)",
  ...
  {
    id: "trip7",
    name: "Horse riding trip to the trip to South Gobi province",
    mainImg: trip7_main,
