...
export const tripsEn = [
  {
    ...
    paragraph: [
      ...
      "-	If you wish to travel on your own, we can make special arrangements upon your request.",
      "-	Prices may vary depending on the number of people. ",
      "-	Given sufficient prior notice, we can flexibly change the duration of the trip. ",
      "The price for a trip includes the following costs: ",
      "-	1 night in a 2-3-star hotel, room for two guests; ",
      "-	7 nights in a Mongolian gher;",
      "-	Transportation during entire trip, including the driver’s fee;",
      "-	Tour Guide’s fee; ",
      "-	Food during the trip;",
      "-	Horse and camel riding fees, fishing; ",
      "-	Entrance to National Parks and museums;",
      "-	City tour, concert.",
      "The price for a trip does not include the following costs:",
      "-	Travel insurance;",
  ...
  },
  {
    ...
    transport: "Mini van, a horse, a camel",
    paragraph: [
